...
echo generate_ap_link($ap, "<img src='" . route('graph', ['type' => 'accesspoints_numasoclients', 'id' => $ap['accesspoint_id'], 'from' => '-1d', 'width' => 100, 'height' => 20, 'legend' => 'no', 'bg' => str_replace('#', '', $row_colour)]) . "'>");
echo "<br>\n";
$ap['graph_type'] = 'accesspoints_radioutil';
echo generate_ap_link($ap, "<img src='" . route('graph', ['type' => 'accesspoints_radioutil', 'id' => $ap['accesspoint_id'], 'from' => '-1d', 'width' => 100, 'height' => 20, 'legend' => 'no', 'bg' => str_replace('#', '', $row_colour)]) . "'>");
echo "<br>\n";
$ap['graph_type'] = 'accesspoints_interference';
echo generate_ap_link($ap, "<img src='" . route('graph', ['type' => 'accesspoints_interference', 'id' => $ap['accesspoint_id'], 'from' => '-1d', 'width' => 100, 'height' => 20, 'legend' => 'no', 'bg' => str_replace('#', '', $row_colour)]) . "'>");
echo "<br>\n";
