...
<?php
$bi ="<img src='" . route('graph', ['type' => 'bill_historictransfer', 'id' => $bill_id, 'from' => $unixfrom, 'to' => $unixto, 'imgtype' => 'day', 'width' => 1190, 'height' => 250]) . "'>";
$di ="<img src='" . route('graph', ['type' => 'bill_historictransfer', 'id' => $bill_id, 'from' => \LibreNMS\Config::get('time.day'), 'to' => \LibreNMS\Config::get('time.now'), 'imgtype' => 'hour', 'width' => 1190, 'height' => 250]) . "'>";
$mi ="<img src='" . route('graph', ['type' => 'bill_historictransfer', 'id' => $bill_id, 'from' => $lastmonth, 'to' => $rightnow, 'imgtype' => 'day', 'width' => 1190, 'height' => 250]) . "'>";
?>
