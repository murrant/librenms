...
return [
    ...
    'discover' => [
        'description' => 'Scan your network for hosts',
        'community' => 'v1/v2c Community',
        'domain' => 'Domain name',
        'domain_placeholder' => 'example: librenms.org',
        'localhost' => 'Add localhost?',
        'networks' => 'Networks',
        'networks_placeholder' => 'Semicolon seperated CIDR networks',
        'ping' => 'Include ping only?',
        'ping_tip' => 'It is not recommended to enable this checkbox! Any failure will add the device as ping only, requiring manual intervention to change to snmp.',
        'scan' => 'Scan',
        'snmp' => 'Default SNMP Credentials',
        'snmp_help' => 'These SNMP credentials will be tried in order if specific credentials are not specified when adding devices',
