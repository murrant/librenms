...
@section('content')
    <div class="tw:max-w-3xl tw:mx-auto tw:py-10 tw:px-4">
        ...
        <h2 class="tw:font-semibold tw:text-gray-800 tw:dark:text-gray-100 tw:mb-6">
        ...
        <div
            class="tw:rounded-lg tw:border tw:border-gray-200 tw:dark:border-gray-700 tw:bg-white tw:dark:bg-dark-gray-400 tw:p-6 tw:shadow-sm"
            x-data="deviceDeleteButton"
        >
            ...
            <hr class="tw:my-5 tw:border-gray-200 tw:dark:border-dark-gray-100">
            ...
            >
                ...
                >
                    <div class="tw:flex tw:items-center tw:min-w-0 tw:gap-3 tw:border-b tw:border-gray-100 tw:dark:border-gray-700 tw:px-6 tw:py-4">
                        <div class="tw:text-2xl tw:break-all tw:xs:break-normal tw:font-semibold tw:text-gray-900 tw:dark:text-gray-100">
                            <i class="fa fa-warning fa-2xl"></i>
                            <span  x-text="'{{ __('device.delete') }}'.replace(':name', name)"></span>
                        </div>
                    </div>
                    ...
                    <div class="tw:flex tw:justify-end tw:gap-3 tw:border-t tw:border-gray-100 tw:dark:border-gray-700 tw:px-6 tw:py-4">
                        <button
                            type="button"
                            class="tw:rounded-md tw:bg-white tw:dark:bg-gray-700 tw:px-4 tw:py-2 tw:font-medium tw:text-gray-700 tw:dark:text-gray-300 tw:hover:bg-gray-100 tw:dark:hover:bg-gray-600 tw:transition-colors"
                        ...
                        <form method="POST" :action="actionUrl">
                            ...
                            <button
                                type="submit"
                                class="tw:rounded-md tw:bg-red-600 tw:px-4 tw:py-2 tw:font-medium tw:text-white! tw:hover:bg-red-700 tw:transition-colors"
                            >
                                {{ __('Delete') }}
                            </button>
                        </form>
