    ...
    <td>
        <div class="tw-flex tw-flex-row">
            ...
            @foreach($port->transceivers as $transceiver)
                ...
                @endphp
                <x-popup>
                    <span class="tw-ml-4 tw-text-3xl"><x-icons.transceiver/></span>
                    <x-slot name="body">
                        @if(array_filter($transceiver->only(['type', 'vendor', 'model', 'revision', 'serial', 'data', 'ddm', 'encoding', 'distance', 'wavelength', 'connector'])))
                        <div class="tw--m-4 tw-opacity-90 tw-p-4 tw-border-b-2 tw-border-solid tw-border-gray-200 dark:tw-border-dark-gray-200 tw-rounded-t-lg">
