...
@else
    <form method="POST" action="{{ route('device.edit.polling.store', $device) }}" x-data="{ methodType: '', credentialMode: 'existing' }">
        ...
        <div x-show="methodType !== ''" style="display: none;" x-transition>
            <div class="tw:mb-6 tw:p-4  tw:rounded-lg tw:border tw:border-gray-200 tw:dark:border-dark-gray-400">
            ...
            <div x-show="credentialMode === 'existing'" class="tw:mb-6 tw:max-w-2xl" style="display: none;" x-transition>
            ...
            <div x-show="credentialMode === 'new'" class="tw:mb-6" style="display: none;" x-transition>
                ...
                @foreach($unconfiguredMethods as $method)
                    <div x-show="methodType === '{{ $method['type']->value }}'" class=" tw:p-5 tw:rounded-lg tw:border tw:border-gray-200 tw:dark:border-dark-gray-400 tw:max-w-2xl">
